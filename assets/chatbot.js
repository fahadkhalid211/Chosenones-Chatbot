(function () {
  ...
  function openModal(fileId, title) {
    ...
    $("vsc-modal-player").appendChild(iframe);
  ...
  function init() {
    ...
    fetch(VSC_CONFIG.dataUrl)
      ...
      .then(function (extractor) {
        ...
        setStatus("");
        addMessage(
          'Hi! I can search videos by meaning \u2014 not just keywords. ' +
          'Hi! You can search all of “Amato The Mentor’s” videos by meaning — not just keywords.Try typing a topic like <em>\u201cfaith\u201d</em>, <em>\u201cforgiveness\u201d</em>, or <em>\u201cprayer\u201d</em>.',
          "bot"
        );
      })
      .catch(function (err) {
